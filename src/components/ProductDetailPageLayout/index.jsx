        ...
        <div className="product-detail-top-chain">
          ...
          <section className="product-detail-head">
            ...
            <div className="review-summary">
              <img alt="4 out 5 stars" className="star" src={filledStarIcon} />
              <img alt="4 out 5 stars" className="star" src={filledStarIcon} />
              <img alt="4 out 5 stars" className="star" src={filledStarIcon} />
              <img alt="4 out 5 stars" className="star" src={filledStarIcon} />
          ...
          <div className="product-detail-additional">
            <section className="product-detail-swatch">
              ...
              <div className="swatch-row">
                ...
                />
                <button data-tip="Tan" style={{ backgroundColor: "#f4edda" }} />
              </div>
            </section>
            ...
            <section className="product-detail-text-description">
              <h1>Description</h1>
              <p>
                Tailored look. Sweatpant feel. Made of soft double-knit fabric,
                the Dream Pant features an elastic waist, pintuck detailing, and
                a sleek tapered leg. Plus, it has a flat finish, so it looks
                polished, but it’s comfortable enough to nap in. The best part?
                It’s wrinkle resistant. From morning meetings to afternoon
                errands to late-night lounging—this pant looks (and feels) like
                a dream.
              </p>
            </section>
          ...
          <section className="product-detail-promo">
            ...
            <div className="product-detail-promo-description">
              ...
              <p>
                ...
                Phasellus vestibulum nunc non malesuada tempor. Nulla convallis
                pretium ornare. Integer interdum leo vel accumsan luctus.
                Vestibulum ac augue efficitur, egestas libero sed, volutpat
                enim. Pellentesque id nulla sapien. In vitae condimentum tellus.
                Donec eget laoreet arcu, dignissim dapibus elit.
              </p>
            </div>
          </section>
